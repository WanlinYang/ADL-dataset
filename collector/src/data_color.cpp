...
void cloud_cb(const sensor_msgs::PointCloud2ConstPtr& input){
  ...
  if(Mode == MASK_VIEW || Mode == CROP){
    ...
    color_cond->addComparison(pcl::PackedRGBComparison<pcl::PointXYZRGB>::Ptr (new pcl::PackedRGBComparison<pcl::PointXYZRGB> 
    ...
    condrem.setInputCloud (cloud_rmtable);
